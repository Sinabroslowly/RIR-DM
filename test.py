...
def main():
    ...
    with torch.no_grad():
        for B_spec, text_embedding, image_embedding, input_image, paths in tqdm(test_loader, desc=f"Test Validaiton:", leave=False):
            ...
            for t in reversed(model.scheduler.timesteps):
